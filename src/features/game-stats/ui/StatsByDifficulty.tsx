...
export const StatsByDifficulty = memo<StatsByDifficultyProps>(({ stats }) => (
  <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
    <div className="px-4 py-3 border-b border-slate-100">
      <h3 className="font-semibold text-slate-800">난이도별 통계</h3>
    </div>
          ...
          {stats.map((stat) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-3 font-tabular text-slate-700">{stat.gamesPlayed}</td>
                <td className="px-4 py-3 font-tabular text-slate-700">{stat.completedGames}</td>
                ...
                <td className="px-4 py-3 font-tabular font-semibold text-slate-800">
