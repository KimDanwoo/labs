...
export default function SettingsModal({ onReset, onClose, isAnonymous, onLinkGoogle }: SettingsModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-sm modal-content p-6 mx-4 space-y-6 animate-scale-in">
        <div className="flex justify-between items-center">
          ...
          <button onClick={onClose} className="text-gray-400 text-xl btn-press">✕</button>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="surface rounded-2xl p-4 space-y-3">
            <div>
              ...
              <div className="text-xs text-amber-500 mt-0.5">코인과 해금 캐릭터는 유지돼요</div>
            </div>
            <button
              onClick={handleReset}
