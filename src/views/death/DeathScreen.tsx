...
export default function DeathScreen({ characterId, nickname, onReset }: DeathScreenProps) {
	return (
		<div className="flex flex-col items-center justify-center flex-1 px-6 gap-6 bg-gray-100">
			<div className="text-center space-y-4">
				...
				<h2 className="text-xl font-bold text-gray-600">{nickname}(이)가 떠났어요...</h2>
				<p className="text-sm text-gray-400">밥을 잘 챙겨주고 청소도 해줘야 해요</p>
			</div>

			<button onClick={onReset} className="px-8 py-3 rounded-xl bg-gray-700 text-white font-bold btn-press">
				다시 시작하기
			</button>
		</div>
	);
