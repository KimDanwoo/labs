...
type CharacterSelectViewProps = {
  onSelect: (characterId: CharacterId, nickname: string) => void;
};

const CHARACTER_LIST = Object.values(CHARACTERS);

export default function CharacterSelectView({ onSelect }: CharacterSelectViewProps) {
  ...
  const handleStart = () => {
    ...
    onSelect(current.id, nickname.trim());
  };
        ...
        <div className="relative flex flex-col items-center gap-8 w-full max-w-xs">
          ...
          <div className="w-full space-y-2">
            ...
            <input
              ...
              style={{ borderColor: nickname.trim() ? current.borderColor : '#E5E7EB' }}
              autoFocus
    ...
    <div className="flex flex-col items-center justify-center flex-1 relative overflow-hidden">
      ...
      <div className="relative flex flex-col items-center gap-6 sm:gap-8 w-full">
        ...
        <div className="text-center space-y-1">
          <h1 className="text-3xl sm:text-4xl font-black tracking-tight bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 bg-clip-text text-transparent">
            PLAVE GOTCHI
          </h1>
