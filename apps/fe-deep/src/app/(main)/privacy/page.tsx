...
export default function PrivacyPolicyPage() {
  return (
    <div className="container mx-auto max-w-[48rem] px-4 py-8 sm:py-12">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p>프딥은 Google OAuth를 통한 로그인 시 아래 정보를 수집합니다.</p>
        ...
        <section>
          ...
          <p>
            회원 탈퇴 시 수집된 개인정보는 즉시 파기됩니다. 단, 관련 법령에 따라 보존이 필요한 경우 해당 기간 동안
            보관합니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p>프딥은 이용자의 개인정보를 원칙적으로 외부에 제공하지 않습니다. 다만, 아래의 경우에는 예외로 합니다.</p>
          <ul className="list-disc pl-5 space-y-1 mt-2">
        ...
        <section>
          ...
          <p>회원 탈퇴 요청 시 해당 이용자의 개인정보 및 학습 데이터는 즉시 삭제되며 복구할 수 없습니다.</p>
        </section>
        ...
        <section>
          ...
          <p>이용자는 언제든지 마이페이지에서 회원 탈퇴를 통해 개인정보의 삭제를 요청할 수 있습니다.</p>
        </section>

        <section>
          <h2 className="text-lg font-semibold mb-3">8. 개인정보 보호 책임자</h2>
          <p>개인정보 처리방침에 관한 문의는 아래 연락처로 문의해 주세요.</p>
          <ul className="list-disc pl-5 space-y-1 mt-2">
            <li>서비스명: 프딥</li>
        ...
        <section>
          ...
          <p>
            본 개인정보 처리방침은 법령, 정책 또는 서비스 변경에 따라 수정될 수 있으며, 변경 시 본 페이지를 통해
            공지합니다.
          </p>
        </section>
      </div>
