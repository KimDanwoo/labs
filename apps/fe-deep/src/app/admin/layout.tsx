...
import { ExternalLink, FileText, LayoutDashboard, MessageSquare, Plus } from 'lucide-react';
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        active ? 'text-foreground bg-muted font-medium' : 'text-muted-foreground hover:text-foreground hover:bg-muted',
      )}
    >
      {children}
    </Link>
