...
export function FlashcardSetup({
  ...
  return (
    <div className="container mx-auto max-w-[42rem] px-4 py-8 sm:py-12 animate-fade-in">
      ...
      <p className="text-muted-foreground mb-8">간격 반복으로 장기 기억에 남기세요.</p>
      ...
      {dueCount > 0 && (
        <Card className="p-4 mb-6 border-primary/20 bg-primary/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-sm">오늘 복습할 카드가 {dueCount}개 있습니다</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-1.5">
            ...
            <Button
              ...
              className="gap-1.5 transition-all duration-200"
            >
              <Brain className="h-3.5 w-3.5" />새 카드
            </Button>
            <Button
      ...
      <div className="mt-6 p-4 rounded-xl bg-muted/40 border border-border/50">
        <p className="text-xs text-muted-foreground leading-relaxed">
          <strong className="text-foreground/70">학습 방법:</strong> 질문을 보고 머릿속으로 답을 떠올린 뒤 카드를
          뒤집으세요. 정답과 비교해서 얼마나 잘 기억했는지 평가하면, 시스템이 최적의 복습 시점을 자동으로 계산합니다.
        </p>
      </div>
    </div>
  );
