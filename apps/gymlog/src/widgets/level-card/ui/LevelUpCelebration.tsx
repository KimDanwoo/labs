...
export function LevelUpCelebration() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/85 px-lg backdrop-blur-sm">
      <div className="pop flex w-full max-w-mobile flex-col items-center gap-lg rounded-xl border border-primary bg-glass p-3xl text-center">
        ...
        <div className="flex flex-col gap-xs">
          ...
          <p className="text-sm text-muted-foreground">꾸준함이 캐릭터를 키웠어요 💪</p>
        </div>
