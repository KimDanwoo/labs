...
export const initializeGameAtom = atom(
  null,
  (get, set, difficulty: Difficulty = GAME_LEVEL.MEDIUM) => {
...
/** 게임 모드 전환 */
export const switchGameModeAtom = atom(
  null,
  (get, set, args: { mode: GameMode; difficulty?: Difficulty }) => {
...
/** 게임 재시작 */
export const restartGameAtom = atom(
  null,
  (get, set) => {
