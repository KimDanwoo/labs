...
import type { CumulativePointsEntry } from '@features/game-record/model/services';
...
export const CumulativeLeaderboardTable = memo<CumulativeLeaderboardTableProps>(
    ...
    return (
      <div className="overflow-x-auto">
        <table className="w-full">
          <caption className="sr-only">누적 포인트 순위표</caption>
          <thead>
            <tr
              className={cn(
                'text-left text-xs',
            ...
            >
              ...
              <th className="pb-3 font-medium">누적 포인트</th>
              <th className="pb-3 font-medium hidden sm:table-cell">게임 수</th>
            </tr>
          </thead>
          <tbody>
