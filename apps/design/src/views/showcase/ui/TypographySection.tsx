  ...
  return (
    <Section title="Typography" description="폰트 패밀리 · 크기 스케일 · 굵기. 값은 각 토큰을 그대로 적용해 렌더.">
      <div className="flex flex-col gap-md">
        <h3 className="text-xs font-semibold uppercase tracking-widest text-muted">family</h3>
      ...
      <div className="flex flex-col gap-md">
        <h3 className="text-xs font-semibold uppercase tracking-widest text-muted">size</h3>
      ...
      <div className="flex flex-col gap-md">
        <h3 className="text-xs font-semibold uppercase tracking-widest text-muted">weight</h3>
