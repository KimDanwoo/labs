...
import { coinsAtom, heartsAtom, inventoryAtom } from '@entities/game/model/store';
import { FOODS, HEART_EXCHANGE_COINS, HEART_EXCHANGE_UNIT } from '@shared/constants';
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 py-2 rounded-xl text-sm font-bold transition-colors ${
                tab === SHOP_TAB.FOOD ? 'bg-orange-100 text-orange-600' : 'bg-gray-100 text-gray-400'
              }`}
            >
              🍖 음식
            </button>
            <button
              ...
              className={`flex-1 py-2 rounded-xl text-sm font-bold transition-colors ${
                tab === SHOP_TAB.EXCHANGE ? 'bg-pink-100 text-pink-600' : 'bg-gray-100 text-gray-400'
              }`}
            >
              💱 교환
            </button>
