        ...
        <div className="flex h-[88vh] max-h-[720px] flex-col">
          <header className="flex items-center justify-between border-b border-card-border px-4 py-3">
            <div className="min-w-0">
              <h3 className="text-base font-bold text-gray-800">{roomName}</h3>
              <ChatOnlineBar users={onlineUsers} />
            </div>
            <button
              onClick={close}
              className="ml-2 flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-gray-400 hover:bg-gray-50 hover:text-gray-600"
              aria-label="닫기"
            >
              ✕
            </button>
