...
<h3>Canvas (Instructure) LMS, 랜섬웨어 공격으로 중단</h3>
<a href="https://www.theverge.com/tech/926458/canvas-shinyhunters-breach" class="source-link" target="_blank" rel="noopener noreferrer">원문보기 →</a>
</div>
...
<div class="news-header">
<h3>Dirtyfrag: 범용 리눅스 LPE 취약점</h3>
<a href="https://www.openwall.com/lists/oss-security/2026/05/07/8" class="source-link" target="_blank" rel="noopener noreferrer">원문보기 →</a>
</div>
...
<div class="news-header">
<h3>당분간 새 소프트웨어 설치는 잠시 보류하는 게 좋습니다</h3>
<a href="https://xeiaso.net/blog/2026/abstain-from-install/" class="source-link" target="_blank" rel="noopener noreferrer">원문보기 →</a>
</div>
...
<div class="news-header">
<h3>자연어 오토인코더: Claude의 생각을 텍스트로 변환하기</h3>
<a href="https://www.anthropic.com/research/natural-language-autoencoders" class="source-link" target="_blank" rel="noopener noreferrer">원문보기 →</a>
</div>
...
<div class="news-header">
<h3>AlphaEvolve: Gemini 기반 코딩 에이전트, 다양한 분야에서 영향력 확장</h3>
<a href="https://deepmind.google/blog/alphaevolve-impact/" class="source-link" target="_blank" rel="noopener noreferrer">원문보기 →</a>
</div>
